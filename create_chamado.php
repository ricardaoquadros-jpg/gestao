...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($titulo)) {
        ...
        try {
            ...
            $stmt = $pdo->prepare("
                INSERT INTO chamados (titulo, descricao, status, responsavel_id, criado_por) 
                VALUES (?, ?, ?, ?, ?)
            ");
            $stmt->execute([
                $titulo,
            ...
            setMensagem('Chamado criado com sucesso!', 'success');
            redirecionar('dashboard.php');
            
        } catch (PDOException $e) {
            $erro = 'Erro ao criar chamado. Tente novamente.';
        }
    }
}
?>
...
<head>
    ...
    <title>Novo Chamado - <?= SITE_NAME ?></title>
    ...
    <div class="app-container">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="create_chamado.php" class="nav-item active">
                    <span class="nav-icon">➕</span>
                            ...
                            <select id="responsavel_id" name="responsavel_id">
                                ...
                                <?php foreach ($usuarios as $usuario): ?>
                                    <option value="<?= $usuario['id'] ?>" 
                                        <?= ($_POST['responsavel_id'] ?? '') == $usuario['id'] ? 'selected' : '' ?>>
